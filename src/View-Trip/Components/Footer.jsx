      ...
      <div className="container mx-auto px-4">
        <div className="flex flex-col md:flex-row justify-between items-center">
          <div className="mb-4 md:mb-0">
            <div className="flex items-center">
              ...
              <span className="font-bold text-lg text-gray-900">Fun Tour AI</span>
            </div>
            <p className="text-sm text-gray-600 mt-1">Discover your perfect trip with AI assistance</p>
          </div>
        ...
        <div className="mt-8 border-t border-gray-200 pt-6">
          <div className="flex flex-col md:flex-row md:justify-between items-center">
            <p className="text-sm text-gray-600">© {currentYear} Fun Tour AI. All rights reserved.</p>
            <div className="mt-4 md:mt-0">
              <ul className="flex space-x-6">
                ...
                <li><a href="#" className="text-sm text-gray-600 hover:text-indigo-600 transition-colors">Contact Us</a></li>
              </ul>
            </div>
          </div>
        </div>
